...
#define LIS2DTW12_I2C_ADD_L   (0x31U >> 1)
#define LIS2DTW12_I2C_ADD_H   (0x33U >> 1)
...
int32_t lis2dtw12_power_mode_set(lis2d_sensor_t* dev,
                                 lis2dtw12_mode_t val);
int32_t lis2dtw12_power_mode_get(lis2d_sensor_t* dev,
                                 lis2dtw12_mode_t *val);
...
int32_t lis2dtw12_data_rate_set(lis2d_sensor_t* dev,
                                lis2dtw12_odr_t val);
...
int32_t lis2dtw12_flag_data_ready_get(lis2d_sensor_t* dev,
                                      uint8_t *val);
...
int32_t lis2dtw12_temperature_raw_get(lis2d_sensor_t* dev,
                                      int16_t *val);

int32_t lis2dtw12_acceleration_raw_get(lis2d_sensor_t* dev,
                                       int16_t *val);
...
int32_t lis2dtw12_self_test_set(lis2d_sensor_t* dev,
                                lis2dtw12_st_t val);
...
int32_t lis2dtw12_spi_mode_set(lis2d_sensor_t* dev,
                               lis2dtw12_sim_t val);
...
int32_t lis2dtw12_tap_threshold_x_get(lis2d_sensor_t* dev,
                                      uint8_t *val);

int32_t lis2dtw12_tap_threshold_y_set(lis2d_sensor_t* dev, uint8_t val);
int32_t lis2dtw12_tap_threshold_y_get(lis2d_sensor_t* dev,
                                      uint8_t *val);
...
int32_t lis2dtw12_tap_threshold_z_get(lis2d_sensor_t* dev,
                                      uint8_t *val);
...
int32_t lis2dtw12_fifo_data_level_get(lis2d_sensor_t* dev,
                                      uint8_t *val);
